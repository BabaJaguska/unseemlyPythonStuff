...
<title>C1W4A_Build_a_Conditional_GAN</title>
...
<h1 id="Build-a-Conditional-GAN">Build a Conditional GAN<a class="anchor-link" href="#Build-a-Conditional-GAN">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Goals">Goals<a class="anchor-link" href="#Goals">&#182;</a></h3><p>In this notebook, you're going to make a conditional GAN in order to generate hand-written images of digits, conditioned on the digit to be generated (the class vector). This will let you choose what digit you want to generate.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Getting-Started">Getting Started<a class="anchor-link" href="#Getting-Started">&#182;</a></h2><p>For this assignment, you will be using the MNIST dataset again, but there's nothing stopping you from applying this generator code to produce images of animals conditioned on the species or pictures of faces conditioned on facial characteristics.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h4 id="Packages-and-Visualization">Packages and Visualization<a class="anchor-link" href="#Packages-and-Visualization">&#182;</a></h4>
</div>
</div>
</div>
...
<span class="n">torch</span><span class="o">.</span><span class="n">manual_seed</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="c1"># Set for our testing purposes, please do not change!</span>

<span class="k">def</span> <span class="nf">show_tensor_images</span><span class="p">(</span><span class="n">image_tensor</span><span class="p">,</span> <span class="n">num_images</span><span class="o">=</span><span class="mi">25</span><span class="p">,</span> <span class="n">size</span><span class="o">=</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">28</span><span class="p">,</span> <span class="mi">28</span><span class="p">),</span> <span class="n">nrow</span><span class="o">=</span><span class="mi">5</span><span class="p">,</span> <span class="n">show</span><span class="o">=</span><span class="kc">True</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h4 id="Generator-and-Noise">Generator and Noise<a class="anchor-link" href="#Generator-and-Noise">&#182;</a></h4>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<span class="sd">    &#39;&#39;&#39;</span>
    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">input_dim</span><span class="o">=</span><span class="mi">10</span><span class="p">,</span> <span class="n">im_chan</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span> <span class="n">hidden_dim</span><span class="o">=</span><span class="mi">64</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">make_gen_block</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">input_channels</span><span class="p">,</span> <span class="n">output_channels</span><span class="p">,</span> <span class="n">kernel_size</span><span class="o">=</span><span class="mi">3</span><span class="p">,</span> <span class="n">stride</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span> <span class="n">final_layer</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
        <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">        Function to return a sequence of operations corresponding to a generator block of DCGAN;</span>
<span class="sd">        a transposed convolution, a batchnorm (except in the final layer), and an activation.</span>
...
<span class="sd">        &#39;&#39;&#39;</span>
    ...
    <span class="k">def</span> <span class="nf">forward</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">noise</span><span class="p">):</span>
        <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">        Function for completing a forward pass of the generator: Given a noise tensor, </span>
<span class="sd">        returns generated images.</span>
<span class="sd">        Parameters:</span>
<span class="sd">            noise: a noise tensor with dimensions (n_samples, input_dim)</span>
<span class="sd">        &#39;&#39;&#39;</span>
...
<span class="k">def</span> <span class="nf">get_noise</span><span class="p">(</span><span class="n">n_samples</span><span class="p">,</span> <span class="n">input_dim</span><span class="p">,</span> <span class="n">device</span><span class="o">=</span><span class="s1">&#39;cpu&#39;</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">    Function for creating noise vectors: Given the dimensions (n_samples, input_dim)</span>
<span class="sd">    creates a tensor of that shape filled with random numbers from the normal distribution.</span>
<span class="sd">    Parameters:</span>
<span class="sd">        n_samples: the number of samples to generate, a scalar</span>
<span class="sd">        input_dim: the dimension of the input vector, a scalar</span>
<span class="sd">        device: the device type</span>
<span class="sd">    &#39;&#39;&#39;</span>
    <span class="k">return</span> <span class="n">torch</span><span class="o">.</span><span class="n">randn</span><span class="p">(</span><span class="n">n_samples</span><span class="p">,</span> <span class="n">input_dim</span><span class="p">,</span> <span class="n">device</span><span class="o">=</span><span class="n">device</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h4 id="Discriminator">Discriminator<a class="anchor-link" href="#Discriminator">&#182;</a></h4>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">class</span> <span class="nc">Discriminator</span><span class="p">(</span><span class="n">nn</span><span class="o">.</span><span class="n">Module</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">    Discriminator Class</span>
<span class="sd">    Values:</span>
<span class="sd">      im_chan: the number of channels in the images, fitted for the dataset used, a scalar</span>
<span class="sd">            (MNIST is black-and-white, so 1 channel is your default)</span>
<span class="sd">      hidden_dim: the inner dimension, a scalar</span>
<span class="sd">    &#39;&#39;&#39;</span>
    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">im_chan</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span> <span class="n">hidden_dim</span><span class="o">=</span><span class="mi">64</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">make_disc_block</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">input_channels</span><span class="p">,</span> <span class="n">output_channels</span><span class="p">,</span> <span class="n">kernel_size</span><span class="o">=</span><span class="mi">4</span><span class="p">,</span> <span class="n">stride</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span> <span class="n">final_layer</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
        <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">        Function to return a sequence of operations corresponding to a discriminator block of the DCGAN; </span>
<span class="sd">        a convolution, a batchnorm (except in the final layer), and an activation (except in the final layer).</span>
<span class="sd">        Parameters:</span>
<span class="sd">            input_channels: how many channels the input feature representation has</span>
<span class="sd">            output_channels: how many channels the output feature representation should have</span>
<span class="sd">            kernel_size: the size of each convolutional filter, equivalent to (kernel_size, kernel_size)</span>
...
<span class="sd">        &#39;&#39;&#39;</span>
    ...
    <span class="k">def</span> <span class="nf">forward</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">image</span><span class="p">):</span>
        <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">        Function for completing a forward pass of the discriminator: Given an image tensor, </span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Class-Input">Class Input<a class="anchor-link" href="#Class-Input">&#182;</a></h2><p>In conditional GANs, the input vector for the generator will also need to include the class information. The class is represented using a one-hot encoded vector where its length is the number of classes and each index represents a class. The vector is all 0's and a 1 on the chosen class. Given the labels of multiple images (e.g. from a batch) and number of classes, please create one-hot vectors for each label. There is a class within the PyTorch functional library that can help you.</p>
<details>
...
<span class="c1"># GRADED FUNCTION: get_one_hot_labels</span>

<span class="kn">import</span> <span class="nn">torch.nn.functional</span> <span class="k">as</span> <span class="nn">F</span>
<span class="k">def</span> <span class="nf">get_one_hot_labels</span><span class="p">(</span><span class="n">labels</span><span class="p">,</span> <span class="n">n_classes</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">    Function for creating one-hot vectors for the labels, returns a tensor of shape (?, num_classes).</span>
<span class="sd">    Parameters:</span>
<span class="sd">        labels: tensor of labels from the dataloader, size (?)</span>
...
<span class="sd">    &#39;&#39;&#39;</span>
    ...
    <span class="k">return</span> <span class="n">torch</span><span class="o">.</span><span class="n">nn</span><span class="o">.</span><span class="n">functional</span><span class="o">.</span><span class="n">one_hot</span><span class="p">(</span><span class="n">labels</span><span class="p">,</span> <span class="n">n_classes</span><span class="p">)</span>
...
<span class="c1"># GRADED FUNCTION: combine_vectors</span>
<span class="k">def</span> <span class="nf">combine_vectors</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">    Function for combining two vectors with shapes (n_samples, ?) and (n_samples, ?).</span>
<span class="sd">    Parameters:</span>
<span class="sd">      x: (n_samples, ?) the first vector. </span>
<span class="sd">        In this assignment, this will be the noise vector of shape (n_samples, z_dim), </span>
<span class="sd">        but you shouldn&#39;t need to know the second dimension&#39;s size.</span>
<span class="sd">      y: (n_samples, ?) the second vector.</span>
<span class="sd">        Once again, in this assignment this will be the one-hot class vector </span>
<span class="sd">        with the shape (n_samples, n_classes), but you shouldn&#39;t assume this in your code.</span>
<span class="sd">    &#39;&#39;&#39;</span>
    <span class="c1"># Note: Make sure this function outputs a float no matter what inputs it receives</span>
    <span class="c1">#### START CODE HERE ####</span>
    <span class="n">combined</span> <span class="o">=</span> <span class="n">torch</span><span class="o">.</span><span class="n">cat</span><span class="p">((</span><span class="n">x</span><span class="p">,</span><span class="n">y</span><span class="p">),</span><span class="n">dim</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span><span class="o">.</span><span class="n">float</span><span class="p">()</span>
    <span class="c1">#### END CODE HERE ####</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Training">Training<a class="anchor-link" href="#Training">&#182;</a></h2><p>Now you can start to put it all together!
First, you will define some new parameters:</p>
<ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">mnist_shape</span> <span class="o">=</span> <span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">28</span><span class="p">,</span> <span class="mi">28</span><span class="p">)</span>
...
<span class="n">dataloader</span> <span class="o">=</span> <span class="n">DataLoader</span><span class="p">(</span>
    <span class="n">MNIST</span><span class="p">(</span><span class="s1">&#39;.&#39;</span><span class="p">,</span> <span class="n">download</span><span class="o">=</span><span class="kc">False</span><span class="p">,</span> <span class="n">transform</span><span class="o">=</span><span class="n">transform</span><span class="p">),</span>
...
<span class="c1"># GRADED FUNCTION: get_input_dimensions</span>
<span class="k">def</span> <span class="nf">get_input_dimensions</span><span class="p">(</span><span class="n">z_dim</span><span class="p">,</span> <span class="n">mnist_shape</span><span class="p">,</span> <span class="n">n_classes</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
<span class="sd">    Function for getting the size of the conditional input dimensions </span>
<span class="sd">    from z_dim, the image shape, and number of classes.</span>
<span class="sd">    Parameters:</span>
...
<span class="sd">    &#39;&#39;&#39;</span>
    <span class="c1">#### START CODE HERE ####</span>
    <span class="n">generator_input_dim</span> <span class="o">=</span> <span class="kc">None</span>
    <span class="n">discriminator_im_chan</span> <span class="o">=</span> <span class="kc">None</span>
    <span class="c1">#### END CODE HERE ####</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">test_input_dims</span><span class="p">():</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">generator_input_dim</span><span class="p">,</span> <span class="n">discriminator_im_chan</span> <span class="o">=</span> <span class="n">get_input_dimensions</span><span class="p">(</span><span class="n">z_dim</span><span class="p">,</span> <span class="n">mnist_shape</span><span class="p">,</span> <span class="n">n_classes</span><span class="p">)</span>
...
<span class="c1">#UNIT TEST NOTE: Initializations needed for grading</span>
...
<span class="k">for</span> <span class="n">epoch</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">n_epochs</span><span class="p">):</span>
    ...
    <span class="k">for</span> <span class="n">real</span><span class="p">,</span> <span class="n">labels</span> <span class="ow">in</span> <span class="n">tqdm</span><span class="p">(</span><span class="n">dataloader</span><span class="p">):</span>
        ...
        <span class="n">fake_noise</span> <span class="o">=</span> <span class="n">get_noise</span><span class="p">(</span><span class="n">cur_batch_size</span><span class="p">,</span> <span class="n">z_dim</span><span class="p">,</span> <span class="n">device</span><span class="o">=</span><span class="n">device</span><span class="p">)</span>
        ...
        <span class="c1">#### START CODE HERE ####</span>
        <span class="n">noise_and_labels</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="n">fake</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="c1">#### END CODE HERE ####</span>
        ...
        <span class="c1">#### START CODE HERE ####</span>
        <span class="n">fake_image_and_labels</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="n">real_image_and_labels</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="n">disc_fake_pred</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="n">disc_real_pred</span> <span class="o">=</span> <span class="kc">None</span>
        <span class="c1">#### END CODE HERE ####</span>
        ...
        <span class="k">if</span> <span class="n">cur_step</span> <span class="o">%</span> <span class="n">display_step</span> <span class="o">==</span> <span class="mi">0</span> <span class="ow">and</span> <span class="n">cur_step</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="p">:</span>
            ...
            <span class="n">show_tensor_images</span><span class="p">(</span><span class="n">fake</span><span class="p">)</span>
            ...
            <span class="n">num_examples</span> <span class="o">=</span> <span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">generator_losses</span><span class="p">)</span> <span class="o">//</span> <span class="n">step_bins</span><span class="p">)</span> <span class="o">*</span> <span class="n">step_bins</span>
            <span class="n">plt</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span>
                <span class="nb">range</span><span class="p">(</span><span class="n">num_examples</span> <span class="o">//</span> <span class="n">step_bins</span><span class="p">),</span> 
                <span class="n">torch</span><span class="o">.</span><span class="n">Tensor</span><span class="p">(</span><span class="n">generator_losses</span><span class="p">[:</span><span class="n">num_examples</span><span class="p">])</span><span class="o">.</span><span class="n">view</span><span class="p">(</span><span class="o">-</span><span class="mi">1</span><span class="p">,</span> <span class="n">step_bins</span><span class="p">)</span><span class="o">.</span><span class="n">mean</span><span class="p">(</span><span class="mi">1</span><span class="p">),</span>
                <span class="n">label</span><span class="o">=</span><span class="s2">&quot;Generator Loss&quot;</span>
            <span class="p">)</span>
            <span class="n">plt</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span>
                <span class="nb">range</span><span class="p">(</span><span class="n">num_examples</span> <span class="o">//</span> <span class="n">step_bins</span><span class="p">),</span> 
                <span class="n">torch</span><span class="o">.</span><span class="n">Tensor</span><span class="p">(</span><span class="n">discriminator_losses</span><span class="p">[:</span><span class="n">num_examples</span><span class="p">])</span><span class="o">.</span><span class="n">view</span><span class="p">(</span><span class="o">-</span><span class="mi">1</span><span class="p">,</span> <span class="n">step_bins</span><span class="p">)</span><span class="o">.</span><span class="n">mean</span><span class="p">(</span><span class="mi">1</span><span class="p">),</span>
                <span class="n">label</span><span class="o">=</span><span class="s2">&quot;Discriminator Loss&quot;</span>
            <span class="p">)</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Exploration">Exploration<a class="anchor-link" href="#Exploration">&#182;</a></h2><p>You can do a bit of exploration now!</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Before you explore, you should put the generator</span>
<span class="c1"># in eval mode, both in general and so that batch norm</span>
<span class="c1"># doesn&#39;t cause you issues and is using its eval statistics</span>
<span class="n">gen</span> <span class="o">=</span> <span class="n">gen</span><span class="o">.</span><span class="n">eval</span><span class="p">()</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h4 id="Changing-the-Class-Vector">Changing the Class Vector<a class="anchor-link" href="#Changing-the-Class-Vector">&#182;</a></h4><p>You can generate some numbers with your new model! You can add interpolation as well to make it more interesting.</p>
...
<span class="n">n_interpolation</span> <span class="o">=</span> <span class="mi">9</span> <span class="c1"># Choose the interpolation: how many intermediate images you want + 2 (for the start and end image)</span>
<span class="n">interpolation_noise</span> <span class="o">=</span> <span class="n">get_noise</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="n">z_dim</span><span class="p">,</span> <span class="n">device</span><span class="o">=</span><span class="n">device</span><span class="p">)</span><span class="o">.</span><span class="n">repeat</span><span class="p">(</span><span class="n">n_interpolation</span><span class="p">,</span> <span class="mi">1</span><span class="p">)</span>

<span class="k">def</span> <span class="nf">interpolate_class</span><span class="p">(</span><span class="n">first_number</span><span class="p">,</span> <span class="n">second_number</span><span class="p">):</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h4 id="Changing-the-Noise-Vector">Changing the Noise Vector<a class="anchor-link" href="#Changing-the-Noise-Vector">&#182;</a></h4><p>Now, what happens if you hold the class constant, but instead you change the noise vector? You can also interpolate the noise vector and generate an image at each step.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">n_interpolation</span> <span class="o">=</span> <span class="mi">9</span> <span class="c1"># How many intermediate images you want + 2 (for the start and end image)</span>

<span class="c1"># This time you&#39;re interpolating between the noise instead of the labels</span>
<span class="n">interpolation_label</span> <span class="o">=</span> <span class="n">get_one_hot_labels</span><span class="p">(</span><span class="n">torch</span><span class="o">.</span><span class="n">Tensor</span><span class="p">([</span><span class="mi">5</span><span class="p">])</span><span class="o">.</span><span class="n">long</span><span class="p">(),</span> <span class="n">n_classes</span><span class="p">)</span><span class="o">.</span><span class="n">repeat</span><span class="p">(</span><span class="n">n_interpolation</span><span class="p">,</span> <span class="mi">1</span><span class="p">)</span><span class="o">.</span><span class="n">float</span><span class="p">()</span>

<span class="k">def</span> <span class="nf">interpolate_noise</span><span class="p">(</span><span class="n">first_noise</span><span class="p">,</span> <span class="n">second_noise</span><span class="p">):</span>
    <span class="c1"># This time you&#39;re interpolating between the noise instead of the labels</span>
...
<span class="c1"># Generate noise vectors to interpolate between</span>
<span class="c1">### Change me! ###</span>
