...
def get_gen_loss(gen, disc, real, condition, adv_criterion, recon_criterion, lambda_recon):
    ...
    fakes = gen(condition)
    real_fake_prediction_matrix = disc(fakes, condition).detach()
    a_loss = adv_criterion(real_fake_prediction_matrix, torch.ones_like(real_fake_prediction_matrix))
    r_loss = recon_criterion(fakes, real)
    gen_loss = a_loss  + r_loss * lambda_recon
